...
public class ViewFileDetails extends javax.swing.JFrame {
    ...
    public ViewFileDetails(String fileDirctory,String user) {
        ...
        FileDetailsTable.setModel(new DefaultTableModel(dbHelper.getSelectedFileTableData(fileDirctory,user), tableColumnNames));
