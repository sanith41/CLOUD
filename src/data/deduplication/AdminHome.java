        ...
        int isFileSelected = fileUploader.showOpenDialog(null); 
            ...
            { 
                try {
                    ...
                    int sizeOccupied = fileOperations.uploadFile(fileUploader.getSelectedFile().getAbsolutePath(),User);
                    CloudsimUtility.simulateCloudSim(fileUploader.getSelectedFile().getAbsolutePath(), sizeOccupied);

                } catch (ParameterException ex) {} catch (GeneralSecurityException ex) {
